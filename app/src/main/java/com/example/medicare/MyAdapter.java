...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_staggered_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int pos) {
        ...
        Picasso.get().load(model.getNewsimage()).placeholder(R.drawable.baseline_lock_24).into(holder.staggeredImages);
    }
